...
public class AppDbSeed
{
    public AppDbSeed(ModelBuilder builder)
    {
        ...
        {
            new IdentityRole() {
               Id = "0b44ca04-f6b0-4a8f-a953-1f2330d30894", /* gid é chave fixa por segurança */
               Name = "Administrador",
        ...
        List<Usuario> users = new() {
            new Usuario(){
                ...
                EmailConfirmed = true,
                Nome = "Tainara Vitória Dos Santos",
                DataNascimento = DateTime.Parse("19/12/2001"),
                Foto = "/img/usuarios/tainaraFoto.svg"
            }
        };
        foreach (var user in users)
        {
            PasswordHasher<IdentityUser> pass = new();
            user.PasswordHash = pass.HashPassword(user, "@147258");
        }
